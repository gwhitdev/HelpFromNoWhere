        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('organisations') }}" :active="request()->routeIs('organisations')">
                        {{ __('Organisations') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('opportunities') }}" :active="request()->routeIs('opportunities')">
                        {{ __('Opportunities') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('visibilities') }}" :active="request()->routeIs('visibilities')">
                        {{ __('Visibilities') }}
                    </x-jet-nav-link>
